...
<!-- 	<?php print_r($_POST); ?> -->
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
     <?php echo "<link rel='stylesheet' href='".content_url()."/themes/Avada/assets/css/theme-my-login.css'>";?>
...
<script src='https://www.google.com/recaptcha/api.js'></script>
	...
	<?php $pages_with_css = array('13454', '13750', '13503', '13764', '14918', '13726', '14559', '13760', '13747', '13743', /*'13612',*/ '13745', /*'13739',*/ '13741', '17360' , '16130', '16127', '14692', '16127', '17352'); ?>

   <?php echo "<link rel='stylesheet' href='".content_url()."/themes/Avada/assets/css/responsive.css'>";?>
   <?php echo "<link rel='stylesheet' href='".content_url()."/themes/Avada/assets/css/responsive2.css'>";?>


	<?php if(in_array($c_page_id, $pages_with_css)) : ?>

		<?php echo "<link rel='stylesheet' href='".content_url()."/themes/Avada/assets/css/events.css'>";?>
		<?php echo "<link rel='stylesheet' href='".content_url()."/themes/Avada/assets/css/lists.css'>";?>
		<?php echo '<link rel="stylesheet" href="https://cdn.jsdelivr.net/sweetalert2/6.3.2/sweetalert2.css">';?>
		<?php echo '<script type="text/javascript" src="https://cdn.jsdelivr.net/sweetalert2/6.3.2/sweetalert2.js"></script>';?>
					...
					<div class="top-header-left clearfix">
						<div class="top-header-logo-holder">
							<a href="<?php echo home_url(); ?>" class="top-header-logo">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/temp/fbg-logo.png" alt="<?php bloginfo( 'name' ); ?>" style="width:90%;padding-left:20px;">
							</a>
						</div>
						...
						<div class="top-header-button">
							<div class="chambres-dans"><span class="color-secondary"><?php 
								...
								<?php
								$sinceimg = get_stylesheet_directory_uri().'/images/temp/DEPUIS-1974.png';
							} else {
