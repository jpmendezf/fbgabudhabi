							...
							<div class="fusion-row">
								...
								<div class="m_footer_pay_links">
									...
									<ul class="m_list_footer_pay">
										...
										<li><img src="http://belpro.co/fbg/wp-content/themes/Avada/assets/images/visa-mastercard1.png" alt=""></li>
										<li><img src="http://belpro.co/fbg/wp-content/themes/Avada/assets/images/visa-mastercard2.png" alt=""></li>
									</ul>
								</div>
							</div> <!-- fusion-row -->
						</footer> <!-- #footer -->
