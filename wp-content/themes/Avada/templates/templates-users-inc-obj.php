	...
	<div class="item_grid">
		<div class="company_info_wrap">
			<h6 class="company_name_2">
				<a href='<?php echo get_permalink(14559); ?>?uid=<?php echo $user_id; ?>'><?php echo $user_l ." ". $user_f; ?></a>
			</h6>
			...
			<p class="member_since">
				...
				if(is_user_logged_in()) {
					...
					if(strlen($mailadr) == 0) { $mailadr = ""; $mail_icon = ''; $mail_display = ' style="display:none" '; }
