...
?>
<div class="fusion-page-title-bar set_h_of_title_fusion fusion-page-title-bar-<?php echo $content_type; ?> fusion-page-title-bar-<?php echo $alignment; ?>">
	<div class="fusion-page-title-row">
		<div class="fusion-page-title-wrapper">
			<div class="fusion-page-title-captions on_resp_set_wfull">
				...
				<?php if ( $title ) : ?>
					...
					<h1<?php echo $entry_title_class; ?>>
					<?php 
					if ( is_singular('company') ) {
                          if(ICL_LANGUAGE_CODE=='fr') {
                              
                              print htmlentities("Détails de l'entreprise", ENT_COMPAT,'ISO-8859-15');
                          }
                          else{
