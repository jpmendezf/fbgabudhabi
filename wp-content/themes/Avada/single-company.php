...
?>
<div class="members_company_on_page p_t_0" style=>
	...
	<div class="content_on_company_on_page dispInline p_b_0">
		...
		<div class="set_login_img set_new_style_img" style="float:none!important; margin: auto!important;">
			...
			<div class="set_content_on_img_login">
				...
				<!-- <div class="resgister_now">
					<p style="font-size: 25px!important;padding-top: 13px;padding-bottom: : 13px;">Become a member or Login to have full accces!</p>
				</div> -->
...
<div class="members_company_on_page">
	...
	<div class="content_on_company_on_page">
		...
		<div class="row">
			...
			// $result6 = $wpdb->get_results("SELECT * FROM wp_users WHERE user_meta={$user_id} AND meta_key=position");	
			// foreach ($result6 as $row6) {
			// 	$position=$row6->meta_value;			
			// }
				...
				// $mailUser = get_user_meta( $user_id , 'mail', true );
