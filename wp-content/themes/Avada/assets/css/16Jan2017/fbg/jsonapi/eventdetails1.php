...
//if(isset($_GET['user']) && intval($_GET['user'])) {
 ...
 // _EventVenueID
    ...
    $query = "";
	$query .= "SELECT wp_posts.ID event_id, CONVERT(CAST(wp_posts.post_title as BINARY) USING latin1) as event_title,  wp_posts.post_content event_description ,
	...
	if($format == 'json') {
		...
		echo json_encode(array("success" => "1",'events'=>$posts),true);
	}
	else {
