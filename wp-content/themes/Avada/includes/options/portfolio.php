			...
			'general_portfolio_options_subsection' => array(
				...
				'fields'      => array(
					...
					'portfolio_items' => array(
						...
						'description' => esc_html__( 'Controls the number of posts that display per page for portfolio elements and portfolio archive pages. Set to -1 to display all. Set to 0 to use the number of posts from Settings > Reading.', 'Avada' ),
						'id'          => 'portfolio_items',
						'default'     => '10',
						'type'        => 'slider',
						'choices'     => array(
			...
			'portfolio_single_post_page_options_subsection' => array(
				...
				'fields'      => array(
					...
					'portfolio_related_posts' => array(
						'label'       => esc_html__( 'Related Privilage', 'Avada' ),
