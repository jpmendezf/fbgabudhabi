			...
			<div class="avada-myaccount-user">
				...
				<?php if ( Avada()->settings->get( 'woo_acc_msg_1' ) ) : 
                    if(ICL_LANGUAGE_CODE=='fr') {
                        // Besoin d'assistance? Appelez le service à la clientèle au
                        $msg = "Besoin d'assistance? Appelez le service à la clientèle au +971 (0)2 674 1137.";

                        ?><span class="msg"><?=htmlentities($msg,ENT_COMPAT,'ISO-8859-15');?></span><?
                    }
                    else{
                        ?>
                ...
                $emailMsg = "Envoyez-les par e-mail à info@fbgabudhabi.com" ;
                if(ICL_LANGUAGE_CODE=='fr') {
                ?>
					<span class="msg"><?=htmlentities($emailMsg,ENT_COMPAT,'ISO-8859-15');?></span><?
                }
                else{
