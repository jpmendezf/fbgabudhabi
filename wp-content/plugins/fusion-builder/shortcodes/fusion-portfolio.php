				...
				if ( has_post_thumbnail() || FusionBuilder::get_theme_option( 'featured_image_placeholder' ) || fusion_get_page_option( 'video', get_the_ID() ) ) {
					...
					if ( 'carousel' == $layout ) {
						...
						if ( 'grid-with-text' === $layout ) {
							...
							// Put it all together.
							$post_content  = '<a href="' . fusion_get_page_option( 'project_url', get_the_ID() ) . '" ' . FusionBuilder::attributes( $classes ) . '><div ' . FusionBuilder::attributes( 'fusion-portfolio-content' ) . '>';
