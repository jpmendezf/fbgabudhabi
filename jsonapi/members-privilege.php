      ...
      // $posts[] =  array("success" => "1");
		while($post = mysql_fetch_assoc($result)) {
            ...
            $post['privilege_image'] = $imgName;
             ...
             // $temp_categories = strip_tags(get_the_category_list( ",", "multiple", $post['privilege_id'] ));
             $preCategory = strip_tags(
                get_the_term_list( $post['privilege_id'], 'portfolio_category', '', ', ', '' )
            );
